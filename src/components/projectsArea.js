...
const ProjectsArea = () => {
  ...
  return (
    <div className='projectAreaContainer' ref={headingRef}>
      ...
      <div className={currentProjectAnimation} style={{cursor: !projectAreaExpanded ? 'pointer' : 'default'}} onClick={() => {!isAnimating && !projectAreaExpanded && setProjectAreaExpanded(prev => !prev)}}>
        {/* <div className='projectArea projectAreaMain' ref={projectItemRef}> */}
        <div className='projectArea projectAreaMain' ref={scrollRef}>
          <div style={{display: 'flex', flexDirection: 'column', height: '100%'}}>
            {projectAreaExpanded &&
              <div className='expandExitBtn' onClick={() => setProjectAreaExpanded(prev => !prev)} style={{cursor: 'pointer'}}>
