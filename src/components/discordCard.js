...
const CoverPhoto = "https://firebasestorage.googleapis.com/v0/b/gagan1337-a73b1.appspot.com/o/portfolio_cover.gif?alt=media&token=347002b3-a801-440a-9fd9-1bbe7aa7889f"

function DiscordCard() {
	const [discordData, setDiscordData] = useState();

	const fetchProfileDataFromLanyardApi = async () => {
		await fetch(`https://api.lanyard.rest/v1/users/${process.env.REACT_APP_DISCORD_PROFILE_ID}`)
    ...
    <div className='discordCard'>
			...
			<div className='contentArea'>
				<div className='discordCardProfileArea'>
					...
					<section className='onlineStatus'>
						...
						<span className='statusOnline'>
							<div style={{height: 16, width: 16, backgroundColor: '#43b581', borderRadius: 50, marginTop: 5, marginLeft: 5}}></div>
						</span>
						: discordData?.discord_status === "idle" ?
						<span className='statusIdle'>
							<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g><path d="M0 0h24v24H0z" fill="none"/><path fill="#faa61a" d="M11.38 2.019a7.5 7.5 0 1 0 10.6 10.6C21.662 17.854 17.316 22 12.001 22 6.477 22 2 17.523 2 12c0-5.315 4.146-9.661 9.38-9.981z"/></g></svg>
						</span>
						: discordData?.discord_status === "dnd" ?
						<span>
							<div style={{height: 16, width: 16, backgroundColor: '#f04747', borderRadius: 50, marginTop: 5, marginLeft:5, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
								<div style={{width: 12, height: 4, borderRadius: 2, backgroundColor: 'rgb(21, 35, 99)'}}></div>
							</div>
						</span>
						: <span>
							<div style={{height: 16, width: 16, backgroundColor: '#747f8d', borderRadius: 50, marginTop: 5, marginLeft:5, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
								<div style={{width: 8, height: 8, borderRadius: 50, backgroundColor: 'rgb(21, 35, 99)'}}></div>
							</div>
						</span>
						}	
					</section>
				...
				<div className='discordCardDetailArea'>
					<h1 className='bannerName'>{discordData?.discord_user.username}<span className='bannerNameTag'>#{discordData?.discord_user.discriminator}</span></h1>
					<div className='bannerDivider'></div>
					<h5 className='bannerSectionTitle'>About Me</h5>
					<p className='bannerAbout'>Web Developer</p>
					<h5 className='bannerSectionTitle'>Member Since</h5>
					<div className='bannerHorizontalSection'>
						<svg className='discordIcon' style={{marginTop: 'auto'}} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="rgb(166 ,172 ,179)" d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515a.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0a12.64 12.64 0 0 0-.617-1.25a.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057a19.9 19.9 0 0 0 5.993 3.03a.078.078 0 0 0 .084-.028a14.09 14.09 0 0 0 1.226-1.994a.076.076 0 0 0-.041-.106a13.107 13.107 0 0 1-1.872-.892a.077.077 0 0 1-.008-.128a10.2 10.2 0 0 0 .372-.292a.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127a12.299 12.299 0 0 1-1.873.892a.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028a19.839 19.839 0 0 0 6.002-3.03a.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419c0-1.333.956-2.419 2.157-2.419c1.21 0 2.176 1.096 2.157 2.42c0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419c0-1.333.955-2.419 2.157-2.419c1.21 0 2.176 1.096 2.157 2.42c0 1.333-.946 2.418-2.157 2.418Z"/></svg>
						<p className='bannerAbout' style={{marginBottom: 0}}>June 21, 2018</p>
					</div>
					{	discordData?.listening_to_spotify && <>
						<div style={{display: 'flex', flexDirection: 'row'}}>
							<h5 className='bannerSectionTitle'>Listening to spotify</h5>
							<div style={{height: 25, width: 25, marginTop: 20, position: 'absolute', right: 15}}>
							...
							<path stroke="null" id="Spotify" fill-rule="evenodd" fill="#10BC4C" d="m10.966428,0c-6.031536,0 -10.966429,4.934893 -10.966429,10.966429s4.934893,10.966429 10.966429,10.966429s10.966429,-4.934893 10.966429,-10.966429s-4.880061,-10.966429 -10.966429,-10.966429m5.044557,15.846489c-0.219329,0.328993 -0.603154,0.438657 -0.932146,0.219329c-2.577111,-1.590132 -5.812207,-1.919125 -9.650457,-1.041811c-0.383825,0.109664 -0.712818,-0.164496 -0.822482,-0.493489c-0.109664,-0.383825 0.164496,-0.712818 0.493489,-0.822482c4.167243,-0.932146 7.786164,-0.548321 10.637436,1.206307c0.383825,0.164496 0.438657,0.603154 0.274161,0.932146m1.315971,-3.015768c-0.274161,0.383825 -0.76765,0.548321 -1.151475,0.274161c-2.960936,-1.809461 -7.457171,-2.357782 -10.911596,-1.261139c-0.438657,0.109664 -0.932146,-0.109664 -1.041811,-0.548321c-0.109664,-0.438657 0.109664,-0.932146 0.548321,-1.041811c4.002746,-1.206307 8.937639,-0.603154 12.337232,1.480468c0.328993,0.164496 0.493489,0.712818 0.219329,1.096643m0.109664,-3.0706c-3.509257,-2.083621 -9.376296,-2.30295 -12.721057,-1.261139c-0.548321,0.164496 -1.096643,-0.164496 -1.261139,-0.657986c-0.164496,-0.548321 0.164496,-1.096643 0.657986,-1.261139c3.893082,-1.151475 10.308443,-0.932146 14.366021,1.480468c0.493489,0.274161 0.657986,0.932146 0.383825,1.425636c-0.274161,0.383825 -0.932146,0.548321 -1.425636,0.274161" clip-rule="evenodd"/>
							</g>
							</svg>
							</div>
						</div>
						<div className='spotifyContent'>
							<img className='spotifyAlbumArt' src={discordData?.spotify.album_art_url}/>
							<div className='spotifySongDetails'>
								<div className='bannerAbout spotifySongName spotifySongText'>{discordData?.spotify.song}</div>
								<div className='bannerAbout spotifySongText'>by {discordData?.spotify.artist}</div>
								<div className='bannerAbout spotifySongText'>on {discordData?.spotify.album}</div>
							</div>
						</div>
						</>
					}
